...
class Reduce1D : public benchmark::Fixture {
 public:
  void SetUp(const benchmark::State& state) override {
    printf("1/Users/visheshrangwani/pytorch/benchmarks/cpp/tensorexpr/bench_reduce.cpp\n");
...
class Reduce2DCol : public benchmark::Fixture {
 public:
  void SetUp(const benchmark::State& state) override {
    printf("2/Users/visheshrangwani/pytorch/benchmarks/cpp/tensorexpr/bench_reduce.cpp\n");
    at::set_num_threads(1);
    torch::manual_seed(0x12345678);
    M = state.range(0);
    N = state.range(1);
...
class Reduce2DRow : public benchmark::Fixture {
 public:
  void SetUp(const benchmark::State& state) override {
    printf("3/Users/visheshrangwani/pytorch/benchmarks/cpp/tensorexpr/bench_reduce.cpp\n");
    at::set_num_threads(1);
    torch::manual_seed(0x12345678);
    M = state.range(0);
    N = state.range(1);
