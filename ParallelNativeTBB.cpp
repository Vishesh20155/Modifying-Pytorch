...
void _internal_set_num_threads(int nthreads) {
  printf("1/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNativeTBB.cpp\n");
...
void init_num_threads() {
  ...
  printf("2/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNativeTBB.cpp\n");
  #endif

  #if AT_MKL_ENABLED()
  mkl_set_num_threads(1);
  printf("3/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNativeTBB.cpp\n");
  #endif
...
void set_num_threads(int nthreads) {
  printf("4/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNativeTBB.cpp\n");
...
void set_thread_num(int id) {
  printf("5/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNativeTBB.cpp\n");
  this_thread_id = id;
}
}
