...
void init_num_threads() {
  ...
  if (nthreads > 0) {
    ...
    printf("1/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelOpenMP.cpp\n");
#elif defined(_OPENMP)
    omp_set_num_threads(intraop_default_num_threads());
    printf("2/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelOpenMP.cpp\n");
#endif
  }
}

void set_num_threads(int nthreads) {
  printf("3/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelOpenMP.cpp\n");
...
int get_num_threads() {
  printf("4/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelOpenMP.cpp\n");
#ifdef _OPENMP
...
int get_thread_num() {
  printf("5/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelOpenMP.cpp\n");
  return this_thread_id;
}

namespace internal {
void set_thread_num(int id) {
  printf("6/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelOpenMP.cpp\n");
  this_thread_id = id;
}
}

bool in_parallel_region() {
  printf("7/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelOpenMP.cpp\n");
#ifdef _OPENMP
