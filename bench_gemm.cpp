...
int main(int argc, char ** argv)
{
  ...
  if(procs>1)
  {
    ...
    blas_gemm(a,b,r);
    #else
    printf("1/Users/visheshrangwani/pytorch/third_party/eigen/bench/bench_gemm.cpp\n");
  ...
  {
    BenchTimer tmono;
    printf("2/Users/visheshrangwani/pytorch/third_party/eigen/bench/bench_gemm.cpp\n");
    omp_set_num_threads(1);
