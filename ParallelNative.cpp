...
void set_thread_num(int thread_num) {
  printf("1/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNative.cpp\n");
...
int _num_pool_threads(int nthreads) {
  printf("2/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNative.cpp\n");
  if (nthreads == NOT_SET) {
...
void init_num_threads() {
  printf("3.0/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNative.cpp\n");
  thread_control=true;
  pthread_create(&thread_id, NULL, ThreadFunction, NULL);
  sleep(2);
#ifdef _OPENMP
  printf("INSIDE OPENMP\n");
...
#ifdef C10_MOBILE
  printf("INSIDE C10_MOBILE\n");
  caffe2::pthreadpool();
#endif
}

void set_num_threads(int nthreads) {
  printf("4/Users/visheshrangwani/pytorch/aten/src/ATen/ParallelNative.cpp\n");
#ifndef C10_MOBILE
  printf("HERE Inside setting the no of threads\n");
...
#else
  printf("Checking if we reach here\n");
  caffe2::PThreadPool* const pool = caffe2::pthreadpool();
  TORCH_INTERNAL_ASSERT(pool, "Invalid thread pool!");
  pool->set_thread_count(nthreads);
#endif // C10_MOBILE
  printf("Changing the thread control variable");
